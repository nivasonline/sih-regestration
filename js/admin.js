...
async function viewTeam(teamId) {
  try {
    ...
    modalContent.innerHTML = `
      ...
      <div class="review-solution" style="margin-top:12px;background:rgba(56,189,248,0.05);border:1px solid rgba(56,189,248,0.2);">
        <div class="review-solution-label">💳 PAYMENT TRANSACTION ID</div>
        <div class="review-solution-value" style="font-family:monospace;">${escapeHtml(team.transactionId)}</div>
      </div>
    `;
